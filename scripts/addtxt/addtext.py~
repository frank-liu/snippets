...
for filez in os.listdir(d):
    ...
    try:
    	os.system("mogrify -fill white -font /usr/share/fonts/truetype/freefont/impact.ttf -pointsize 70 -stroke black -strokewidth 2 -gravity north -annotate -4-5 \"All projects of 'disillusionment' for the sake of greater enlightenment:\nsociology is — \nto speak sociologically — \njust a high-culture spokesperson of power.\" "+filez)
